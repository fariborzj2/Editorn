...
- You **MUST** keep `DEVELOPER.md` up-to-date. Whenever you introduce a new feature, change the architecture, add a new block type, or modify APIs, you must immediately document these changes in `DEVELOPER.md`.
- Ensure `PROJECT_BRIEF.md` and `ROADMAP.md` remain accurate if major scope changes occur.
...
## 5. Quality and Architecture Standards
