...
همچنین پلاگین `SlashMenu` توسعه یافته است که در بلوک پاراگراف، با تایپ کردن کاراکتر `/` منویی جهت تبدیل سریع پاراگراف به سایر بلوک‌ها نمایش می‌دهد.


## ۶. استایل‌ها و تم (Styles & Theming)
